								...
								<div className='flex flex-col h-full justify-center'>
									...
									<span className='flex flex-row items-center gap-2'>
										<button
											type='submit'
											value='Send Message'
											className='w-max bg-gradBlue2 text-white text-lg rounded-md flex justify-center items-center gap-3 p-4 my-4 hover:opacity-75 hover:scale-95 hover:outline-4 hover:outline-black ease-in-out delay-50'>
											Send Message
