...
export default function NavBar() {
	return (
		<>
			<nav className='flex sticky top-0 items-center justify-around md:justify-center h-28 w-full p-5 bg-neutral z-50 text-xs md:text-sm md:text-base rounded-b-xl'>
				...
				<div className='flex flex-col align-center justify-center'>
					<ul className='flex flex-row font-semibold spacing-wide md:spacing-widest align-center md:text-lg justify-center gap-2 md:gap-5 cursor-pointer  text-grey'>
